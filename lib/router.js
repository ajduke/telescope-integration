...
PostsListController = FastRender.RouteController.extend({
  ...
  waitOn: function () {
    ...
    this._terms = {
      view: (this.path == '/forum') || (this.path == '/forum/' ) ? 'top' : this.path.split('/')[2],
  ...
  after: function() {
    var view = (this.path == '/forum') || (this.path == '/forum/' ) ? 'top'  : this.path.split('/')[2];
...
Router.map(function() {
  ...
  this.route('posts_category', {
    path: '/forum/category/:slug/:limit?',
    controller: PostsListController,
    after: function() {
  ...
  this.route('posts_digest', {
    path: '/forum/digest/:year/:month/:day',
  ...
  this.route('post_page', {
    path: '/forum/posts/:_id',
    controller: PostPageController
  });

  this.route('post_page', {
    path: '/forum/posts/:_id/comment/:commentId',
    controller: PostPageController,
    after: function () {
      // TODO: scroll to comment position
    }
  ...
  this.route('post_submit', {path: '/forum/submit'});
  ...
  this.route('comment_edit', {
    ...
    this.route('comment_deleted', {
        path: '/forum/comments/deleted'
    });
  ...
  this.route('user_edit', {
    path: '/forum/users/:_idOrSlug/edit',
    controller: UserPageController
  });
  ...
  this.route('forgot_password',{path:'/forum/forgot_password'});

  // All Users

  this.route('all-users', {
    path: '/forum/all-users/:limit?',
    template: 'users',
    waitOn: function() {
  ...
  // User Login In
  this.route('loginForm',{path:'/forum/login'});

  // User Sign-Up
  this.route('signup',{path:'/forum/signup'});

  // User Sign-In
  this.route('signin',{path:'/forum/signin'});
  ...
  this.route('categories',{path:'/forum/categories'});

  // Settings

  this.route('settings',{path:'/forum/settings'});

 // Loading (for testing purposes)

  this.route('loading',{path:'/forum/loading'});

  // Toolbox

  this.route('toolbox',{path:'/forum/toolbox'});

  // Search Logs

  this.route('logs', {
    path: '/forum/logs/:limit?',
    waitOn: function () {
